                    ...
                    <span className="block text-indigo-600">online business</span>
                            ...
                            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                                ...
                                <form action="#" method="POST" className="mt-3 sm:flex">
                                    ...
                                    <input type="text" name="email" id="email" className="block w-full py-3 text-base rounded-md placeholder-gray-500 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:flex-1 border-gray-300" placeholder="Enter your email" />
