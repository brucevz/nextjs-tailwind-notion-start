            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
                    ...
                    {posts.map((post) => (
                        ...
                        <div className="flex flex-col rounded-lg shadow-lg hover:cursor-pointer overflow-hidden">
                            <div className="flex-shrink-0">
                                <img className="h-48 w-full object-cover" src={`${post.image && post.image[0].url}&width=400`} alt="" />
                            </div>
